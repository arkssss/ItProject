...
<link href="/SoaProject/Public/Plugin/UploadFace/css/cropper.css" rel="stylesheet">
<link href="/SoaProject/Public/Plugin/UploadFace/css/sitelogo.css" rel="stylesheet">
<script src="/SoaProject/Public/Plugin/UploadFace/js/cropper.min.js"></script>
<script src="/SoaProject/Public/Plugin/UploadFace/js/sitelogo.js"></script>
<body>
    <!-- 包含侧栏的导航条 -->
...
<div class="_EditProfile_frame container">
    ...
    <div class="_Profile row change_except_password">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="avatar-view center-block" title="">
                        <img src="/SoaProject/Public/Face/face.svg" alt="通用的占位符缩略图" id="my_face" has_change = "false" class="img-circle">
                    </div>
                    <br>
        </div>  
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-lg-offset-2">
                ...
                <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="nickname"  value="<?php echo ($user["username"]); ?>">
                        </div>
                        <div class="form-group">
                            <label for="email">Email : </label>
                            <input type="text" readonly class="form-control" id="email" value="<?php echo ($user["email"]); ?>">
                        </div>
                        <div class="form-group">
                                <label for="email">Phone : </label>
                                <input type="text" readonly class="form-control" id="email" value="<?php echo ($user["phone"]); ?>">
                        </div>
                        <div class="form-group">
                                <label for="email">User Type : </label>
                                <input type="text" readonly class="form-control" id="type"  value="<?php echo ($user["type"]); ?>">
                        </div>
                </form>
        </div>     
    </div>
