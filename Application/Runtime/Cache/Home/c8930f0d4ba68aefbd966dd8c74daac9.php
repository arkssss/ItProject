...
<script>
    ...
    <div class="container">
        ...
        <h1 class="text-center">Your Booked Events</h1>
        <hr>
    <h2 class="text-success">Coming Events</h2>
    <hr>
    <div class="row">
    ...
    <h2 class="text-default">Historical Events</h2>
    <hr>
    <div class="row">
            ...
            <?php if(is_array($pass_event)): $i = 0; $__LIST__ = $pass_event;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-4">
                            <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <p style="margin-top:10px" class="text-center">Ticket Type: <span class="text-danger"><?php echo ($vo["ticket_type"]); ?></span></p>
                                            <p  style="margin-top:10px" class="text-center">
                                            <a href="<?php echo U('ViewItem/detail');?>?id=<?php echo ($vo["show_id"]); ?>" class="btn btn-default" role="button">
                                                    Detail
                                            </a> 
                                            </p>
                                    </div>
                    ...
                    <!-- <div class="col-lg-3">
                            <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                            <img class="center-block _cover img-rounded" src="/SoaProject/Public/photo/1.png" alt="">
                                            <p  style="margin-top:10px" class="text-center">
                                            <a href="<?php echo U('detail');?>" class="btn btn-default" role="button">
                                                    查看详情
                                            </a> 
                                            </p>
                                    </div>
